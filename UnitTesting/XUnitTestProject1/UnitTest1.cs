...
namespace XUnitTestProject1
{
    public class UnitTest1
    {
        ...
        public void CanWithdrawMoney(decimal balance, string withdrawal, string expectedNewBalance)
        {
            // Act
        ...
        public void CannotWithdrawIfYouWouldGoNegative(decimal balance, string withdrawal, string expectedException)
        {
            // Act
        ...
        public void CannotWithdrawNegativeAmount(decimal balance, string withdrawal, string expectedException)
        {
            // Act
            string exception = Program.withdrawMoney(balance, withdrawal);
